        ...
        <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-200">
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center px-4 py-3 border-2 border-gray-300 rounded-lg text-gray-700 bg-white hover:bg-gray-50 hover:border-black focus:outline-none focus:ring-2 focus:ring-black focus:border-black transition-all duration-200 font-medium"
            >
            ...
            <button className="w-full flex items-center justify-center px-4 py-3 border-2 border-gray-300 rounded-lg text-gray-700 bg-white hover:bg-gray-50 hover:border-black focus:outline-none focus:ring-2 focus:ring-black focus:border-black transition-all duration-200 font-medium">
              <svg
